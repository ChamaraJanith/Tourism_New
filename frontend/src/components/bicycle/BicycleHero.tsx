    ...
    <section className="relative h-screen w-full overflow-hidden flex items-center justify-center">
      ...
      <div className="absolute inset-0 z-0">
        ...
        >
          ...
          <img src="/images/bicycle_ride/1.webp" alt="Bicycle Hero" className="h-full w-full object-cover" />
        </video>
        <div className="absolute inset-0 bg-gradient-to-b from-black/50 via-emerald-950/10 to-[#0a0c0e]" />
      </div>
      ...
      <div ref={textRef} className="relative z-20 container mx-auto px-6 text-center">
        ...
        <p className="max-w-3xl mx-auto text-lg md:text-2xl text-emerald-50/80 mb-16 animate-text font-light leading-relaxed">
          Ride through tropical villages, scenic lakes, forest trails, and breathtaking landscapes while discovering authentic Sri Lankan culture.
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6 animate-text w-full px-6">
          ...
          >
            <span className="relative z-10">Book Cycling</span>
